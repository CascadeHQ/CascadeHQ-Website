...
import BlackRock from './images/blackrock-logo-1.svg';
  ...
  return (
    <>
      ...
      <section className={`relative flex items-center justify-center overflow-x-hidden`}>
        <div className={`grid grid-cols-7 items-center justify-center gap-4 md:gap-14  animate-marquee whitespace-nowrap`}>
          <img src={Google} alt="Google Logo" className={`mix-blend-color-burn		`}/>
          <img src={BlackRock} alt="BlackRock Logo" className={`mix-blend-color-burn		`}/>
        ...
        <div className={`grid grid-cols-7 items-center justify-center gap-4 pl-4 animate-marqueeSec whitespace-nowrap absolute md:gap-14`}>
          <img src={Google} alt="Google Logo" className={`mix-blend-color-burn		`}/>
          <img src={BlackRock} alt="BlackRock Logo" className={`mix-blend-color-burn		`}/>
          <img src={CocaCola} alt="CocaCola Logo" className={`mix-blend-color-burn		`}/>
          <img src={JPMorgan} alt="JPMorgan Logo" className={`mix-blend-color-burn		`}/>
