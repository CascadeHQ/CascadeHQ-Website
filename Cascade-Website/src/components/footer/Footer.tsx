    ...
    <>
      <footer className={`bg-brandBlue2x`}>
          ...
          <div className="flex flex-col md:flex-row lg:flex-row gap-y-12 md:gap-x-12 lg:gap-x-12">
            <div>
              ...
              {pageLinks.map((page, index) => (
                <div className="flex flex-col gap-y-2.5 mt-2" key={index}>
        ...
        <div className="bg-brandBlue5x p-5 text-center">
          <p className="font-valueRegular text-white text-sm lg:text-base">
            With Love from Cascade, 2023. All rights researved.
          </p>
        </div>
      </footer>
    </>
