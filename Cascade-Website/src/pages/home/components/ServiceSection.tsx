      ...
      <section>
        <div className={`bg-brandBlue6x py-16 flex flex-col gap-10`}>
          <div className={`flex items-center justify-center px-5 md:px-10 lg:px-20`}>
            <h2 className={`text-4xl text-center font-DegularDiplayBold md:text-5xl`}>Benefits of our Service to your Students</h2>
          </div>
          <div className={`grid grid-cols-1 gap-8 items-center justify-center px-5 md:grid-cols-3 md:px-10 lg:px-20`}>
            <section className={`grid grid-cols-1 gap-8 `}>
              <div className={`flex flex-col gap-2 bg-brandBlue4x p-5 rounded-xl shadow-2xl`}>
                <h3 className={`font-euclidBold  text-xl`}>Learn on-demand Tech Skills</h3>
