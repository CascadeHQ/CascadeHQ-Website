  ...
  return (
    <>
      <main className={`bg-[url(/src/pages/aboutUs/images/Background.jpg)] bg-center bg-cover`}>
        <div
          className={`h-fit flex flex-col px-5 xl:flex-row xl:items-center xl:gap-x-36 xl:pl-16`}
        >
          <div className={`flex flex-col gap-y-3.5`}>
            <div>
              <h1
                className={`font-bold text-3xl xl:text-[64px] leading-tight madeTommyRegular`}
              >
                We Teach,
              </h1>
              <h1
            ...
            <div className={`flex items-center xl:items-start gap-x-4 xl:gap-x-8`}>
              ...
              <p className={`madeTommyRegular font-normal text-md md:text-base  xl:font-bold w-full xl:w-[500px] xl:leading-5`}>
